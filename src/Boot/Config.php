...
define('CONF_URL_TEST', 'https://localhost/pnse');
 ...
 * SITE
 */
define('CONF_SITE_NAME', 'Paroquia Nossa Senhora da Esperanca');
define('CONF_SITE_TITLE', 'Fique por dentro do que acontece na Paróquia Nossa Senhora da Esperança');
define('CONF_SITE_LANG', 'pt_BR');
define('CONF_SITE_DESC', 'Site da Paróquia Nossa Senhora da Esperança, situada em Cidade Continental, no município de Serra, estado do Espírito Santo.');
